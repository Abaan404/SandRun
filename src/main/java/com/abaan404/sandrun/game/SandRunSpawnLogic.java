...
import com.abaan404.sandrun.SandRun;
import com.abaan404.sandrun.game.map.SandRunMap;

import java.util.Set;

public class SandRunSpawnLogic {
    private final GameSpace gameSpace;
    private final SandRunMap map;
    private final ServerWorld world;

    public SandRunSpawnLogic(GameSpace gameSpace, ServerWorld world, SandRunMap map) {
    ...
    public void spawnPlayer(ServerPlayerEntity player) {
        ...
        if (pos == null) {
            SandRun.LOGGER.error("Cannot spawn player! No spawn is defined in the map!");
            return;
        }
